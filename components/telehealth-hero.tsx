...
import { ArrowRight, Stethoscope, Video, Monitor, FileText, CheckCircle } from "lucide-react"
import Image from "next/image"

export default function TelehealthHero() {
  return (
      ...
      <div className="container mx-auto px-6 md:px-12 py-24 md:py-32 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            >
              Telehealth <span className="text-[#A7C7E7]">Billing</span> Services
            </motion.h1>
            ...
            >
              Specialized billing solutions for virtual care providers. Maximize reimbursement for telehealth services
              with our expert billing team that understands the unique challenges of remote healthcare delivery.
            </motion.p>
            ...
            >
              {[
                ...
                "Platform-specific billing knowledge",
            ...
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-sm font-medium text-gray-900">Telehealth Growth</div>
                </div>
                <div className="text-3xl font-bold text-[#1E3A8A]">+240%</div>
                <p className="text-xs text-gray-500 mt-1">Increase in telehealth services since 2020</p>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-sm font-medium text-gray-900">Claim Approval</div>
                </div>
                <div className="text-3xl font-bold text-[#1E3A8A]">98%</div>
                <p className="text-xs text-gray-500 mt-1">First-pass approval rate for telehealth claims</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
